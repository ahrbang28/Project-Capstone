...
with col1:
    tab1, tab2, tab3 = st.tabs(['GDP per capita < $20000','GDP per capita >= $20000','Trend Line'])
    with tab1:
...
with col2:
        ...
        st.write(" ")
        st.write(" ")
        st.markdown("""Terdapat trend bahwa Semakin besar total pendapatan, nilai dari pengeluaran Healthy Diet semakin kecil.
        """)
...
with col1:
    ...
    Indonesia sendiri memiliki pengeluaran healthy diet berkisar pada harga \$4.2 dan pengeluaran rata-rata setiap tahunnya menghabiskan sebanyak \$1500.\n
...
with tab1:
    ...
    with col2:
        ...
        st.header(" ")
        st.markdown("""
        Pada tahun 2017 dapat dilihat pada pie chart bahwa sebanyak 36.3% atau 53 negara berada pada kategori Very Cheap dan 26% atau 38 negara berada pada kategori Very Expensive. 
        Negara yang memiliki kategori Healthy Diet mahal yaitu negara yang berada pada kategori expensive dan very expensive berjumlah 54 (37%) 
        dan negera yang memiliki Healthy Diet murah yaitu negara yang berada pada kategori Very Cheap, Cheap, dan Medium berjumlah 92 (63%).
...
with tab2:
    ...
    with col2:
        ...
        st.header(" ")
        st.markdown("""
        Pada tahun 2018 dapat dilihat pada pie chart bahwa sebanyak 38.2% atau 55 negara berada pada kategori Very Cheap dan 27.1% atau 39 negara berada pada kategori Very Expensive. 
        Negara yang memiliki kategori Healthy Diet mahal yaitu negara yang berada pada kategori expensive dan very expensive berjumlah 51 (35.4%) 
        dan negera yang memiliki Healthy Diet murah yaitu negara yang berada pada kategori Very Cheap, Cheap, dan Medium berjumlah 93 (64.6%).
        Sehingga dapat disimpulkan mayoritas negara memiliki kategori Healthy Diet yang tergolong MURAH.
        """)
...
with tab3:
    ...
    with col2:
        ...
        st.header(" ")
        st.markdown("""
        Pada tahun 2019 dapat dilihat pada pie chart bahwa sebanyak 36.8% atau 53 negara berada pada kategori Very Cheap dan 26.4% atau 38 negara berada pada kategori Very Expensive. 
        Negara yang memiliki kategori Healthy Diet mahal yaitu negara yang berada pada kategori expensive dan very expensive berjumlah 52 (36.1%) 
        dan negera yang memiliki Healthy Diet murah yaitu negara yang berada pada kategori Very Cheap, Cheap, dan Medium berjumlah 92 (63.9%).
        Sehingga dapat disimpulkan mayoritas negara memiliki kategori Healthy Diet yang tergolong MURAH.
        """)
...
with tab4:
    ...
    with col2:
        ...
        st.header(" ")
        st.markdown("""
        Pada tahun 2020 dapat dilihat pada pie chart bahwa sebanyak 33.3% atau 48 negara berada pada kategori Very Cheap dan 27.8% atau 40 negara berada pada kategori Very Expensive. 
        Negara yang memiliki kategori Healthy Diet mahal yaitu negara yang berada pada kategori expensive dan very expensive berjumlah 55 (38.2%) 
        dan negera yang memiliki Healthy Diet murah yaitu negara yang berada pada kategori Very Cheap, Cheap, dan Medium berjumlah 89 (61.8%).
        Sehingga dapat disimpulkan mayoritas negara memiliki kategori Healthy Diet yang tergolong MURAH.
        """)
